...
class _MycarsdetailPageState extends State<MycarsdetailPage> {
                                          ...
                                          child: Padding(
                                            ...
                                            child: ElevatedButton(
                                              style: ElevatedButton.styleFrom(
                                                  ...
                                                  onPrimary: const Color.fromARGB(255, 224, 197, 197),
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Image.asset('assets/images/iconscan.png'),
                                                  Text(
                                                    'สแกน',
                                              ...
                                              child: Stack(
                                                children: <Widget>[
                                                  Align(
                                                    ...
                                                    child: Text(widget.model.carid.carWhere.carWhere,
                                                        style: TextStyleMycar.station, textScaleFactor: 1.0),
                                                  ),
                                                  const Align(
  ...
  void _CheckIn({required ReqDBAPI model}) {
    ...
    Future.delayed(const Duration(milliseconds: 1000), () {
      Navigator.push(context, MaterialPageRoute(builder: (_) => CheckinPage(model: widget.model, QR: qrCode)));
    });
  }
